...
const TABS = [
  ...
  { k: 'payers',      label: 'Payers',         roles: ['superadmin', 'admin'] },
  { k: 'providers',   label: 'Providers',      roles: ['superadmin', 'admin'] },
  { k: 'rules',       label: 'Rules',          roles: ['superadmin', 'admin'] },
  { k: 'data',        label: 'Import/Export',  roles: ['superadmin', 'admin'] },
  { k: 'users',       label: 'Users',          roles: ['superadmin', 'admin'] },
